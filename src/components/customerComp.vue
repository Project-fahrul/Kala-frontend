                ...
                <tr v-for="(m, i) in model" :key="i">
                    ...
                    <td class="bx">
                        <p data-placement="top" data-toggle="tooltip" title="Edit"><button
                                class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" @click="edit(m.id)"
                                data-target="#edit">
                    ...
                    <td class="bx">
                        <p data-placement="top" data-toggle="tooltip" title="Delete"><button
                                class="btn btn-danger btn-xs" data-title="Delete" data-toggle="modal" @click="del(m.id, m.name)"
                                data-target="#delete">
